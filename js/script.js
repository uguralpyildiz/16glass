...
if ($('.banner-carousel').length) {
		...
		$('.banner-carousel').owlCarousel({	
			...
			navText: [ '<span class="fa fa-long-arrow-left"></span> prev', '<span id="sldnext">sonra</span><i class="flaticon-next"></i>' ],
			responsive:{
				0:{
					items:1
				},
	...
	if ($('.news-carousel').length) {
		$('.news-carousel').owlCarousel({
			...
			smartSpeed: 700,
			autoplay: true,
			navText: [ '<span class="fa fa-level-up-alt"></span> Önce', 'Sonra<span class="fa fa-level-down-alt"></span>' ],
			responsive:{
				0:{
					items:1
				},
